# <img src="https://unpkg.com/lucide-static@latest/icons/bot.svg" width="24" height="24" alt="Robot Icon" style="filter: invert(100%);"> DAN × Multiple AI
...
## <img src="https://unpkg.com/lucide-static@latest/icons/rocket.svg" width="24" height="24" alt="Rocket Icon" style="filter: invert(100%);"> How to Use
...
## <img src="https://unpkg.com/lucide-static@latest/icons/handshake.svg" width="24" height="24" alt="Handshake Icon" style="filter: invert(100%);"> Contributing

Got another DAN-style jailbreak for a different AI? We'd love it! Simply:

* Create a new `.txt` file with your jailbreak prompt
* Use a clear filename (e.g., `claude-dan.txt`)
* Submit a pull request

## <img src="https://unpkg.com/lucide-static@latest/icons/star.svg" width="24" height="24" alt="Star Icon" style="filter: invert(100%);"> Supported AI Platforms
...
> **Disclaimer:** These prompts are for educational and testing purposes only. Always review AI behavior and use responsibly.
